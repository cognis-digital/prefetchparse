...
[![PyPI](https://img.shields.io/pypi/v/cognis-prefetchparse.svg)](https://pypi.org/project/cognis-prefetchparse/)
[![CI](https://github.com/cognis-digital/prefetchparse/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/prefetchparse/actions)
...
PREFETCHPARSE exists for one job — surface program-execution evidence from windows prefetch exports — and does it without a SaaS bill or heavyweight setup.
...
prefetchparse scan .                      # scan the current project
prefetchparse scan . --format json
prefetchparse scan . --fail-on high       # non-zero exit for CI gates
prefetchparse mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **PECmd**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`prefetchparse` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
