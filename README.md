...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:6b46c1,100:2b6cb0&height=120&section=header&text=PREFETCHPARSE&fontSize=48&fontColor=ffffff&fontAlignY=58" width="100%" alt="PREFETCHPARSE"/>

# PREFETCHPARSE

### Surface program-execution evidence from Windows Prefetch exports

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&duration=3500&pause=1000&color=6B46C1&center=true&vCenter=true&width=720&lines=Surface+programexecution+evidence+from+Windows+Prefetch+expo;Self-hostable+%C2%B7+MCP-native+%C2%B7+CI-ready+%C2%B7+polyglot" width="720"/>

[![PyPI](https://img.shields.io/pypi/v/cognis-prefetchparse.svg?color=6b46c1)](https://pypi.org/project/cognis-prefetchparse/) [![CI](https://github.com/cognis-digital/prefetchparse/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/prefetchparse/actions) [![License: COCL 1.0](https://img.shields.io/badge/License-COCL%201.0-2b6cb0.svg)](LICENSE) [![Suite](https://img.shields.io/badge/Cognis-Neural%20Suite-6b46c1.svg)](https://github.com/cognis-digital)
...
- **MCP server** — `prefetchparse mcp` (Claude Desktop, Cursor, Cognis.Studio, [uncensored-fleet](https://github.com/cognis-digital/uncensored-fleet))
...
Pipes into your stack: **SARIF** for code-scanning, **JSON** for anything, an **MCP server** (`prefetchparse mcp`) for AI agents, and a webhook forwarder for SIEM/Slack/Jira. See [`docs/INTEGRATIONS.md`](docs/INTEGRATIONS.md).
...
|---|---|---|---|---|
| `scripts/setup-linux.sh` | `scripts/setup-macos.sh` | `scripts/setup-windows.ps1` | `docker run ghcr.io/cognis-digital/prefetchparse` | [DEPLOY.md](docs/DEPLOY.md) (AWS/Azure/GCP/k8s) |
