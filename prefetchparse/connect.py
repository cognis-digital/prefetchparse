"""Native cognis-connect emit for prefetchparse — forward findings to any platform.

Maps prefetchparse's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    prefetchparse ... --format json | prefetchparse-emit --to stix
    prefetchparse-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
