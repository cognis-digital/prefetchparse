"""PREFETCHPARSE core — Surface program-execution evidence from Windows Prefetch exports."""
...
RULES = [
    ("PRE-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("PRE-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("PRE-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
