# Ports of prefetchparse

The same scan logic, ported across languages so you can drop prefetchparse into any stack
or ship a single static binary. All ports share the rule IDs and JSON output shape.

| Language | Path | Run |
|---|---|---|
| Python (reference) | `../prefetchparse/` | `prefetchparse scan .` |
