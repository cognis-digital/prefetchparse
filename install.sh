#!/usr/bin/env sh
# Universal installer for prefetchparse. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/prefetchparse.git"
echo "Installing prefetchparse ..."
...
echo "Done. Run: prefetchparse --help"
